...
unset($_SESSION['editdepartmentjobssucess']);
 ?>
       ...
       <?php if(isset($_SESSION['guidancejobhiringdelete'])) {?>
   ...
   <?php }
   unset($_SESSION['guidancejobhiringdelete']);
   ?>
...
<table id="myTable" class="table table-striped" width="100%" style=""> 
        <thead>  
          <tr>  
                        ...
                        <th style="border-bottom:solid 1px;width: 20%;font-size: 1.7vmin;">Company Name</th>  
            <th style="border-bottom:solid 1px;width: 20%;font-size: 1.7vmin;">Uploaded</th>  
            <th style="border-bottom:solid 1px;width: 20%;font-size: 1.7vmin;">Job Title</th>
                            <th style="border-bottom:solid 1px;width: 20%;font-size: 1.7vmin;" >Views</th>    
  ...
  <div class='container1'>
   ...
   <label style=' font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;padding: 0px .3vmin 0px .3vmin;font-weight:600' for='b".$row['id']."'>Close</label>
   </i></label>    
