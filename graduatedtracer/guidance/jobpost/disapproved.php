...
<div id="loading">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
   <?php if(isset($_SESSION['guidancerecover'])) {?>
          ...
          <input type="checkbox" id="tablesuccess"><label for="tablesuccess"  class=""></label>
                     <div class="container-success1" id="successtransition">
                          <div class="container-success01" align="center" >
                                ...
                                <br>
                                <label style="font-size: 25px;margin-top: 20px;">JOB RECOVERED</label>
                                </label><br>
...
unset($_SESSION['guidancerecover']);
 ?>
    ...
    <ul class="sidebar-nav" id="sidebar-nav" style="margin-top: 50px;">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav1" style="background-color: #297FA7;">
          <i class="fa fa-bullhorn"></i><span  style="">Job Posting</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav1" class="nav-content  " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="disapproved.php">
              <i class="bi bi-circle"></i><span style="color:#ADADAD">Disapproved</span>
            </a>
          </li>
...
<table id="myTable" class="table table-striped" width="100%" style=""> 
        ...
        <tbody>  
        <?php 
        $sql = "select * from jobpost where jobstatus = 'Disapproved'";
                              ...
                              <div class='col-xl-12  col-md-12 mt-4 p-1'  align='left' style='box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;'>
                               ...
                               <div style='width:100%;padding:10px 0px 10px 0px'>
                                 <div  style=';width:100%;' > 
                                  ...
                                  <div class='col-xl-12  col-md-12 p-1'  align='left' style='box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;'>
                                <div style='width:100%;padding:10px 0px 10px 0px'>
                                 <div style='width:100%;' >
                                     <label style='width:100%'  class='infolabel1'><img src='../assets/img/notinterested.png' style='height:3vmin;width:3vmin;margin-top:-5px;margin-right:5px'>Reason</label>            
                                 </div>
                                 <div class='p-2' style='width:100%;' >
                                      <label  class='infolabel2'>".$row['reason']."</label>              
                                 </div>
                                </div>
                              </div>
                              </td>
                            </tr>
                                   <form method='POST' action='disapprovedserver.php'>
                              <input type='hidden' name='id' value='".$row['id']."'>
                              <tr>
                              <td colspan='2' style='text-align:right;'>
                               <input type='submit' name='recoverjob' value='Recover' class='recoverbuttonjob' > 
                              </td>
                              </tr>
                              </form>  
