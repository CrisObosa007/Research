...
<script type="text/javascript">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <?php if(isset($_SESSION['guidancependingsuccess'])) {?>
    <div id="undo-hidden">
          <input type="checkbox" id="tabledeleteinfo"><label for="tabledeleteinfo"  class=""></label>
                     <div class="container-success1" id="deleteinfitransition">
                          <div class="container-success01"  align='center'>
                                ...
                                <label class="title_info col-12">
                                <img src="../assets/img/success.gif" style="width: 40%;height:40%" />
                                <br>
                                <label style="font-size: 25px;margin-top: 20px;">JOB APPROVED!</label>
                                </label><br>
   ...
   <?php }
   unset($_SESSION['guidancependingsuccess']);
   ?>
       ...
       <?php if(isset($_SESSION['guidancependingdelete'])) {?>
          ...
          <input type="checkbox" id="tabledeleteinfo"><label for="tabledeleteinfo"  class=""></label>
                     <div class="container-success1" id="deleteinfitransition">
                          <div class="container-success01"  align='center' >
                                ...
                                <label class="title_info col-12" style="width: 30%;">
                                <img src="../assets/img/delete1.gif" style="width: 40%;height:40%" />
                                <br>
                                <label style="font-size: 25px;margin-top: 20px;">JOB DENIED</label>
                                </label><br>
                                <div align="left" class="">
                                <!-- //design -->
                                  <label></label>
   ...
   <?php }
   unset($_SESSION['guidancependingdelete']);
   ?>
    ...
    <ul class="sidebar-nav" id="sidebar-nav" style="margin-top: 50px;">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav1" class="nav-content  " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span style="color:#ADADAD">Pending Job Approval</span>
            </a>
          </li>
          <li>
...
<table id="myTable" class="table table-striped" width="100%" style=""> 
        <thead>  
          <tr>  
            ...
            <th style="border-bottom:solid 1px;width: 25%;font-size: 1.7vmin;">Uploaded</th>  
        ...
        <tbody>  
        <?php 
        $sql = "select * from jobpost where jobstatus = 'Pending'";
        ...
        $qualificationsplit .= "<label class='infolabel2'> • ".$spesplit[$i]."</label><br>";
        ...
        $specializationsplit .= "<label class='infolabel2'> • ".$spesplit2[$i]."</label><br>";
        ...
        if ($collegeuploaded != "guidance" && $collegeuploaded != "admin") {
         $sql1 = "SELECT * FROM college WHERE college='$collegeuploaded'";
        $result1 = mysqli_query($conn,$sql1);
        $row1 = mysqli_fetch_array($result1);
        $collegename = $row1['college'];
        $usernameuploaded = $row1['username'];
      }
        if ($collegeuploaded == "guidance" || $collegeuploaded == "admin") {
           echo" <td class='table_td'>".$row['collegeuploaded']."</td>";
        }else{
           echo" <td class='table_td'>".$usernameuploaded."</td>";
        }

        echo "<td class='table_td'>".$row['jobtitle']."</td>
        <td class='table_td' align='center'>

            <input type='checkbox' id='a".$row['id']."' >
      <label for='a".$row['id']."' style='background-color:#07435f;color:#fff;font-size:1.7vmin;margin:0;padding: 1vmin 1.5vmin 1vmin 1.5vmin;border-radius:3px;display:none' class='classview'>
   ...
   <label style=' font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;padding: 0px .3vmin 0px .3vmin;font-weight:600' for='a".$row['id']."'>View</label>
      ...
      <label for='b".$row['id']."' style='background-color:#009933
;color:#fff;font-size:1.7vmin;margin:0;padding: 1vmin 1.5vmin 1vmin 1.5vmin;border-radius:3px' class='classview'>
   <i class='fa fa-check' style='font-size:1.7vmin;font;font-weight: bold;'>
   <label style=' font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;padding: 0px .3vmin 0px .3vmin;font-weight:600' for='b".$row['id']."'>Approve</label>
   </i></label>
                      ...
                      <div class='container2'>
                          ...
                          <div class='container02'>
                                 ...
                                 <table class='popup_table2' style='background-color:#000;  border-collapse: collapse'>
                            <tr>
                              <td colspan='2'>
                              <div class='closingtab2'>
                             ...
                             <tr>
                              ...
                              <div class='col-xl-12  col-md-12 mt-4 p-1'  align='left' style='box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;'>
                               ...
                               <form method='POST' action='pendingjobserver.php'>
                              <input type='hidden' name='id' value='".$row['id']."'>
                              <input type='hidden' name='specialization' value='".$row['specialization']."'>
                              <tr>
                              <td colspan='2' style='text-align:right;'>
                              
                               <input type='submit' name='submitjob' value='Approve' class='buttonjobApproved'> 
                              </td>
                              </tr>
                              </form> 
      ...
      <label for='c".$row['id']."' style='background-color:#CC0000;color:#fff;font-size:1.7vmin;margin:0;padding: 1vmin 1.5vmin 1vmin 1.5vmin;border-radius:3px' class='classview'>
   <i class='fa fa-times' style='font-size:1.7vmin;font;font-weight: bold;'>
   <label style=' font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;padding: 0px .3vmin 0px .3vmin;font-weight:600' for='c".$row['id']."'>Deny</label>
   </i></label>
                          ...
                          <div class='container03'>
                            ...
                            <tr>
                              ...
                              <div class='closingtab3'>
                                <label for='"."c".$row['id']."' class='close-btn3 fas fa-times' title='close'></label><br>
                              </div>
                               <label style='text-align: center;width:100%;font-size:3.5vmin;color:#0c506f;margin:0;padding:0;font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;'>".$row['companyname']."</label>
                              </td>
                             <tr>
                            ...
                            <tr>
                                ...
                                <div class='col-xl-12  col-md-12 mt-2'  align='center' style='box-shadow: rgba(0, 0, 0, 0.15) 0px 2px 8px;margin-bottom:20px'>
                                 <div class='p-3' style='background-color:white;width:100%;' >
                                      ...
                                      <form action='pendingjobserver.php' method='POST' id='deletepopup' name='deletepopup' onsubmit='return validateReason()'>
                                      ...
                                      <div style='width:100%' align='left'class='form-group options'>
                                          <label class='infolabel1' style='font-size:2.3vmin'>Reason for Denying? <label style='color:red'>*</label></label>
                                             ...
                                             <div style='width:100%'>
                                              <input type='checkbox' name='reasons[]' value='The Company has enough Qualified Applicants' style='display:inline-block;position: relative;height:2.1vmin;width:2.1vmin;margin:5px 0px 0px 5px' required>
                                              <label class='infolabel2'>The Company has enough Qualified Applicants</label>
                                            </div>
                                           <div style='width:100%'>
                                              <input type='checkbox' name='reasons[]' value='The Job Posting is Illegitimate (Scam)' style='display:inline-block;position: relative;height:2.1vmin;width:2.1vmin;margin:5px 0px 0px 5px' required>
                                              <label class='infolabel2'>The Job Posting is Illegitimate (Scam)</label>
                                            </div>
                                     ...
                                     <label style='width:100%;text-align:right;font-size:2vmin;color:#F1F4F2;margin-right:7px;'><button type='submit' name='rejectjob' class='approveno' id='cancelinfo' style='padding:8px;padding-left:15px;padding-right:15px;border:none;background-color:#CC0000;border-radius:3px;'>Deny</button></label>
                                      </form>
          ...
          <style>#c".$row['id'].":checked ~ .container3{display: block;visibility: visible;}</style>
