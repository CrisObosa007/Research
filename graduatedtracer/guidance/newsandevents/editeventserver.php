...
if(isset($_POST['submit'])){
  ...
  if ($fileName == "") {
      ...
      $result1 = mysqli_query($conn,"INSERT INTO alevent (uploadedevent,eventcollege,eventdetail,startdate,starttime,enddate,endtime,venue,address,description,organizer,sponsor,eventimage,eventdate,time,status) values ('guidance','$eventcourse1','$eventdetail','$startdate','$starttime','$enddate','$endtime','$venue','$address','$description','$organizer1','$sponsor1','$allfiles','$eventdate','$time','update')");
        ...
        $_SESSION['guidancediteventsuccess'] = "asdasdsa";
