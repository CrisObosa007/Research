...
// ---------------------saving data ------------------
          ...
          if ($fileName == "") {
                    ...
                    $result1 = mysqli_query($conn,"INSERT INTO alnews (newscollege,newsdetail,description,newsimage,newsdate,newsstatus,newstime) values ('guidance','$newsdetail','$description','$newsimage','$newsdate','update','$time')");
                               ...
                               $result1 = mysqli_query($conn,"INSERT INTO alnews (newscollege,newsdetail,description,newsimage,newsdate,newsstatus,newstime) values ('guidance','$newsdetail','$description','$allfiles','$newsdate','update','$time')");
            ...
            //                   }
                    ...
                    $_SESSION['editguidancenewssucess'] = "asdasdsa";
