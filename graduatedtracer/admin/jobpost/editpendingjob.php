    ...
    for($i=1; $i<sizeof($spesplit); $i++){
      $listqualification .= "
            <div class='d-flex align-items-cente p-2' style='margin-left: 5%;margin-right: 5%;'>
                            ...
                            <input type='text' name='qualification[]' id='' placeholder='Qualification' class='inputlabel' style='width:60%' value='".$spesplit[$i]."'>
...
<script type="text/javascript">
   ...
   <?php if(isset($_SESSION['editadminjobssucess'])) {?>
          ...
          <input type="checkbox" id="tableundo"><label for="tableundo"  class=""></label>
                     <div class="container-undo1">
                          <div class="container-undo01" align="center">
                                ...
                                <br>
                                <label style="font-size: 2em;margin-top: 20px;">JOB UPDATED!</label>
                                </label><br>
                          </div>
                    </div>
...
unset($_SESSION['editadminjobssucess']);
 ?>
     ...
     <a href="../record/college.php">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav1" class="nav-content  " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span  style="color:#ADADAD">Pending Job Approval (Guidance)</span>
            </a>
          </li>
          <li>
  ...
  <form action="editpendingjobserver.php" method="POST" name="contactForm" onsubmit="return validateForm()"  >
  <input type="hidden" name="college" value="<?php echo $college ?>">
    <input type="hidden" name="jobpostdate" value="<?php echo $jobpostdate ?>">
  ...
  <main id="main" class="main">
    ...
    <div class="col-xxl-5 col-md-5" align="right">
      <a href="pendingjob.php" >    <label style='background-color:#07435f;color:#fff;font-size:1.7vmin;margin:0;padding: 1vmin 1.5vmin 1vmin 1.5vmin;border-radius:3px;margin-top: 20px;' class='backbtn'>
          ...
          <div class="col-xxl-6  col-md-6" style="margin-top: 20px;" >
                ...
                <div class="d-flex align-items-cente p-2">
                        <div class="align-items-center" style="width: 40%;">
                          ...
                          <div style="width:60%" >
                            <input type="text" name="jobtitle" id="jobtitle" class="inputlabel" placeholder="Job Title" value="<?php echo $jobtitle; ?>">
                            <br>
                ...
                <div class="d-flex align-items-cente p-2">
                        <div class="align-items-center" style="width: 40%;">
                          ...
                          <div style="width:60%" >
                            <input type="text" name="companyname" class="inputlabel" placeholder="Company Name" value="<?php echo $companyname; ?>">
                            <br>
                 ...
                 <div class="d-flex align-items-cente p-2">
                        <div class="align-items-center" style="width: 40%;">
                          ...
                          <div style="width:60%" >
                            <input type="text"  class="inputlabel" id='email' name='email' placeholder="eg.ucu@gmail.com"  value="<?php echo $email; ?>">
                            <br>
                       ...
                       <div class="d-flex align-items-cente p-2">
                        <div class="align-items-center" style="width: 40%;">
                          ...
                          <div style="width:60%" >
                            <input type="number"  class="inputlabel" id='contact' name='contact' placeholder="09**********"  value="<?php echo $contact; ?>">
                ...
                <div class="d-flex align-items-cente p-2">
                        <div class="align-items-center" style="width: 40%;">
                          ...
                          <div style="width:60%" >
                            <input type="text"  class="inputlabel" id='link' name='link' placeholder="Website Link"  value="<?php echo $link; ?>">
                ...
                <div class="d-flex align-items-cente p-2">
                        <div class="align-items-center" style="width: 40%;">
                          ...
                          <div style="width:60%" >
                            <select name="jobtype" class="inputlabel">
                              ...
                              <option value="Intership" <?php if ($jobtype == "Intership") { echo "selected";} ?>>Intership</option>
                              ...
                              <option value="Part-time" <?php if ($jobtype == "Part-time") { echo "selected";} ?>>Part-time</option>
                                     <option value="Not Specified" <?php if ($jobtype == "Not Specified") { echo "selected";} ?>>Not Specified</option>
                            </select>
                            <br>
                 ...
                 <div class="d-flex align-items-cente p-2">
                        <div class="align-items-center" style="width: 40%;">
                          ...
                          <div style="width:60%" >
                            <input type="text" name="location" class="inputlabel" placeholder="Location"  value="<?php echo $location; ?>">
                            <br>
        ...
        console.log(values);
           ...
           <div class="col-xxl-6  col-md-6" style="margin-top: 20px;">
                ...
                <div class="d-flex align-items-cente" style="margin-left: 5%;margin-right: 5%;">
                          ...
                          <div style="width:30%" >
                            <label style="margin-left: 5px;color: #B2AAAA;font-size: 1.5vmin;margin: 0;padding: 0;" id="optionalcontact">(PHP)</label>
                            <input type="text" name="minimumsalary" id="minumumsalary" class="inputlabel"  style="width:86%" placeholder="Minimum Salary" value='<?php echo $minimumsalary; ?>' />
                           ...
                           <div style="width:35%" >
                             <label style="margin-left: 5px;color: #B2AAAA;font-size: 1.5vmin;margin: 0;padding: 0;" id="optionalcontact">(PHP)</label>
                            <input type="text" name="maximumsalary"  id="maximumsalary" class="inputlabel"  style="width:86%" placeholder="Maximum Salary"  value='<?php echo $maximumsalary; ?>' />
               ...
               <script type="text/javascript" src="https://cdn.jsdelivr.net/jquery/latest/jquery.min.js"></script>
                ...
                <div class="d-flex align-items-cente p-2" style="margin-left: 5%;margin-right: 5%;">
                          <div style="width:70%" >
                            <input type="text" name="daterange"  id="daterange" class="inputlabel"  style="width:86%"  value="<?php echo $startdate . " - " . $enddate ?>" />
            ...
            <div class="clonehide">
              ...
              <div class="d-flex align-items-cente p-2" id="clone" style="margin-left: 5%;margin-right: 5%;">
                            <input type="text" name="qualification[]" id="" placeholder="Qualification" class="inputlabel" style="width:60%" value="<?php echo $spesplit[0]; ?>">
                            <button type="button" class="btn addmore">+</button>
                         
              </div>
              <?php
              echo $listqualification;
               ?>
                <div id="clone_div1">
                </div>
                ...
                <div class="d-flex align-items-cente p-2" >
                 ...
                 <div class="d-flex align-items-cente p-2" >
                        <div class="align-items-center" style="width: 100%;">
                            <textarea name="description" class="inputtextarea"><?php echo $description; ?></textarea>
                            <br>
