...
<script type="text/javascript">
  ...
  <!-- ======= Header ======= -->
      <?php if(isset($_SESSION['canceladminjobssucess'])) {?>
    <div id="undo-hidden">
...
unset($_SESSION['canceladminjobssucess']);
 ?>
...
<table id="myTable" class="table table-striped" width="100%" style=""> 
        ...
        <tbody>  
        <?php 
        $sql = "select * from jobpost where jobstatus = 'pending' and collegeuploaded = 'admin'";
