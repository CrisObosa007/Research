...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
  ...
  if ($username == "admin") {
    ...
    if (isset($_POST['submitgraduated'])) {
      $_SESSION['coursegraduated'] = $_POST['recordcourse'];
      unset($_SESSION['skill']);
      unset($_SESSION['collegecourse']);
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="../dashboard.php" class="logo d-flex align-items-center"  id="bugdashboard">
        ...
        <div class="card-body" align="left">
          <form method="POST" action="grademployment.php">
            <button name="employed" id="employed" type="submit" style="background-color:transparent;border: none;" disabled>
             <h5 style="font-weight: 500;color: #012970;font-family:'Poppins',  sans-serif;padding: 2px;padding-top: 7px;">Employed</h5>
           </button>
         </form>
          ...
          <td>
           <div class='col-xl-12  col-md-12 mt-2'  align='center' style='box-shadow: rgba(0, 0, 0, 0.15) 0px 2px 8px;'>
             <div class='p-3' style='background-color:white;width:100%;' >
              ...
              <form action='coursegraduated.php' method='POST' id='printpop' name='printpop' onsubmit='return validatePrint()'>
