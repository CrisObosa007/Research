...
$course = 'Admin';
  ...
  $sql ="SELECT count(*) as total FROM graduated INNER JOIN employment ON graduated.idno = employment.idno ";
          ...
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                            <?php 
                           $sql ="SELECT count(*) as total FROM graduated INNER JOIN employment ON graduated.idno = employment.idno  where employment.employed = '' ";
                                 $result = mysqli_query($conn,$sql);
                                 while ($row = mysqli_fetch_array($result)) { 
                                    $total  = $row['total']  ;    
                                    echo $total;
                      ...
                      <span class="text-success  fw-bold" ><label style="color:#fff;font-size: 13px;" >
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                            <?php 
                           $sql ="SELECT count(*) as total FROM graduated INNER JOIN employment ON graduated.idno = employment.idno  where employment.employed = 'Yes' ";
                                 $result = mysqli_query($conn,$sql);
                                 while ($row = mysqli_fetch_array($result)) { 
                                    $total  = $row['total']  ;    
                                    echo $total;
                      ...
                      <span class="text-success pt-1 fw-bold" ><label style="color:#fff;font-size: 13px;" >
            ...
            <div class="col-xxl-4 col-md-4">
                ...
                <div class="card-body" >
                  ...
                  <div class="d-flex align-items-center">
                   ...
                   <div class="ps-3">
                      <h6>
                            <?php 
                           $sql ="SELECT count(*) as total FROM graduated INNER JOIN employment ON graduated.idno = employment.idno  where employment.employed = 'No'";
                                 $result = mysqli_query($conn,$sql);
                                 while ($row = mysqli_fetch_array($result)) { 
                                    $total  = $row['total']  ;    
                                    echo $total;
             ...
             <!-- Sales Card -->
                       <!-- Sales Card -->
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card sales-card" style="background-color: #3BA6D8;margin-bottom: 30px;">
                ...
                <div class="card-body" >
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <i class="fas fa-user-graduate" style="color: #297fa7;"></i>
                    </div>
                    <div class="ps-3">
                      <h6>
                          <?php 
            ...
            <div class="col-xxl-4 col-md-4" >
              <div class="card info-card sales-card" style="background-color: #2BBCFF;">
                ...
                <div class="card-body">
                  ...
                  <a href="record/college.php"><h5 class="card-title">Pending Request</h5></a>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                          <?php 
                           $sql ="SELECT count(*) as total from signup where  status = 'Approval'";
                                 $result = mysqli_query($conn,$sql);
                                 while ($row = mysqli_fetch_array($result)) { 
                                    $total  = $row['total']  ;    
                                    echo $total; 
...
// $str2 = date('Y-m-d', strtotime('-7 days', strtotime($todays_date))); 
 ...
 $sql ="SELECT yeargrad,count(yeargrad) as total from graduated group by yeargrad asc";
         ...
         while ($row = mysqli_fetch_array($result)) { 
          ...
          $result=mysqli_query($con,"SELECT yeargrad,count(yeargrad) as total from graduated group by yeargrad asc limit 1");
