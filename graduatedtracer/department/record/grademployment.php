...
<?php }else {?>
  ...
  <div class="col-xxl-8 col-xl-8 col-md-8 col-sm-8" align="right">
   <a href="graduated.php">
    <label style='background-color:#07435f;color:#fff;font-size:1.7vmin;margin:0;padding: 1vmin 1.5vmin 1vmin 1.5vmin;border-radius:3px;margin-top: 20px;' class='graduatedrecord'>
     <i class='fa fa-arrow-left' style='font-size:13px;font;font-weight: bold;'>
       <label style=' font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;padding: 0px .3vmin 0px .3vmin;font-weight:600'>Back</label>
...
echo"          </div>
              ...
              if (isset($_SESSION['employedprint'])) {
               echo "<label style='width:100%;text-align:right;font-size:2vmin;color:#F1F4F2;margin-right:7px;'><button type='submit' name='printinfoemployed' class='printinfoemployed print' id='printinfoemployed' style='padding:8px;padding-left:15px;padding-right:15px;border:none;background-color:#297fa7;border-radius:3px;border:solid 2px #297fa7'>Print</button></label>";

             }
             if (isset($_SESSION['notemployedprint'])) {
              echo "<label style='width:100%;text-align:right;font-size:2vmin;color:#F1F4F2;margin-right:7px;'><button type='submit' name='printinfonotemployed' class='printinfonotemployed print' id='printinfonotemployed' style='padding:8px;padding-left:15px;padding-right:15px;border:none;background-color:#297fa7;border-radius:3px;border:solid 2px #297fa7'>Print</button></label>";

            }
            if (isset($_SESSION['notupdatedprint'])) {
             echo "<label style='width:100%;text-align:right;font-size:2vmin;color:#F1F4F2;margin-right:7px;'><button type='submit' name='printinfonotupdated' class='printinfonotupdated print' id='printinfonotupdated' style='padding:8px;padding-left:15px;padding-right:15px;border:none;background-color:#297fa7;border-radius:3px;border:solid 2px #297fa7'>Print</button></label>";
           }
