...
<aside id="sidebar" class="sidebar" style="background-color: #07435f;">
  ...
  <ul class="sidebar-nav" id="sidebar-nav" style="margin-top: 50px;">
    ...
    <li class="nav-item" data-bs-target="#components-nav11" data-bs-toggle="collapse">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body" style="border-top: 3px solid #297fa7;">
                  <ul class="nav nav-tabs nav-tabs-bordered">
                    ...
                    <li class="nav-item">
                      <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#alumni-overview" onclick="Alumni()" style="font-size: 2.2vmin;">Record</button>
                    </li>
                    ...
                    <table id="myTable1" class="table table-striped" width="100%" style=""> 
                      <thead>  
                        <tr>  
                          ...
                          <th style="border-bottom:solid 1px;font-size: 1.7vmin;width: 20%">Idno</th>  
                          ...
                          <th style="border-bottom:solid 1px;font-size: 1.7vmin;width: 22%">Reason</th> 
                        </tr>  
                      </thead>  
                      <tbody>
                       <style type="text/css">
                         .table_td .sorting_1 .orderdate{
                          color: red;

                        }
                      </style>  
                      <?php 
                      $sql = "SELECT * from algraduated where college = '$college'";
                ...
                <div class="table-responsive"  id="table-responsive2"  style="display: none;">
                  <table id="myTable2" class="table table-striped" width="100%" style=""> 
                   ...
                   <tbody>  
                    <?php 
                    $sql = "SELECT * from aljobpost where collegeuploaded = '$college'";
                    $result = $conn-> query($sql);
                    if ($result-> num_rows > 0 ){
                      while ($row=mysqli_fetch_array($result)){
                        $status = "";
              ...
              <div class="table-responsive"  id="table-responsive3"  style="display: none;">
                <table id="myTable3" class="table table-striped" width="100%" style=""> 
                 ...
                 <tbody>  
                  <?php 
                  $sql = "SELECT * from alnews where newscollege = '$college'";
                  $result = $conn-> query($sql);
                  if ($result-> num_rows > 0 ){
                    while ($row=mysqli_fetch_array($result)){
            ...
            <div class="table-responsive"  id="table-responsive4"  style="display: none;">
              <table id="myTable4" class="table table-striped" width="100%" style=""> 
               ...
               <tbody>  
                <?php 
                $sql = "SELECT * from alevent  where uploadedevent = '$college'";
                $result = $conn-> query($sql);
                if ($result-> num_rows > 0 ){
                  while ($row=mysqli_fetch_array($result)){
