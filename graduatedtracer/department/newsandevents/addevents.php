...
<body>
 ...
 var eventdetailErr = eventdayErr =startdateErr = starttimeErr  = endtimeErr = venueErr = addressErr = descriptionErr   = organizerErr = sponsorsErr = fileErr = true;
...
if(sponsors == "") {
    ...
    //
if(file == "") {
    printError("fileErr", "Please Select Image");
} else {
 ...
 if (extFile=="jpg" || extFile=="jpeg" || extFile=="png"){
  ...
  fileErr = false;
    ...
    printError("fileErr", "Invalid Image Only accept (PNG/JPEG/JPG)");
} 
...
if((eventdetailErr || eventdayErr ||startdateErr || starttimeErr || endtimeErr || venueErr || addressErr || descriptionErr  || organizerErr || sponsorsErr || fileErr) == true) {
 return false;
} else {
    if (review == "1") {
    }
...
<!-- ======= Header ======= -->
<?php if(isset($_SESSION['departmenteventsuccess'])) {?>
    <div id="undo-hidden">
      ...
      <div class="container-undo1">
          <div class="container-undo01" align="center">
            ...
            <label class="title_info">
                ...
                <br>
                <label style="font-size: 2em;margin-top: 20px;">EVENT UPLOADED!</label>
            </label><br>
        </div>
    </div>
...
unset($_SESSION['departmenteventsuccess']);
?>
...
<form action="addeventserver.php" method="POST" name="contactForm" onsubmit="return validateForm()" id="formulario"  enctype="multipart/form-data">
         ...
         <div class="col-xxl-12 col-xl-12 col-md-12 col-12" style="margin-top: 5px;">
          <div class="d-flex align-items-cente p-2" style="background-color:white;">
              <div class="align-items-center " style="width: 100%;">
                ...
                <label id="descriptionInfo" class="outputpreview01" style="margin-left: 30px;margin-right: 30px;"></label>
            </div>              
        </div>
    </div>
      ...
      <div class="col-xxl-7 col-xl-7 col-md-7 col-12" style="background-color: #fff;margin-top: 20px;">
       <div class="d-flex align-items-cente p-2 ">
          <div class="align-items-center" style="width: 100%;margin-left: 13px;margin-right: 13px;margin-top: 10px">
            ...
            <br>
            <input type="text" name="eventdetail"  style="width: 100%;" class="labelinput" placeholder="Event Title">
...
<div class="d-flex align-items-cente p-2 ">
  <div class="align-items-center" style="width: 100%;margin-left: 13px;margin-right: 13px;">
    ...
    <br>
    <input type="radio" id="html" name="eventday" value="1" style="height:15px; width:15px;vertical-align: top" onclick="javascript:myDay1();">
    <label for="html" style="font-size: 1.7vmin;margin-right: 10px;color: #383838;font-weight: 500;vertical-align: top;margin-top: 3px;" onclick="javascript:myDay1();" >1 Day</label>
    <input type="radio" id="css" name="eventday" value="2"  style="height:15px; width:15px;vertical-align: top" onclick="javascript:myDay2();">
    <label for="css" style="font-size: 1.7vmin;margin-right: 10px;color: #383838;font-weight: 500;margin-top: 3px;"  onclick="javascript:myDay2();">2 or More Days</label>
    <label id="eventdayErr" class="failed" style="width:100%;display: none;"  ></label>
</div>      
</div>
...
<div class="d-flex align-items-cente p-2" >
    <div class="col-xxl-12  col-md-12" style="padding:0px;width: 100%;">
        <div  id="date1" name="date1" style="display:none">
            <div class="col-xxl-6 col-xl-6 col-md-6 col-12" > 
              <div class="align-items-center">
                <label class='labelguild'>Start Date 1</label>
                <br>
                <input type="date" name="startdate"  style="width: 100%;" class="labelinput">
                <label id="startdateErr" class="failed"></label>
            </div> 
        </div>
    </div>  

    <div  id="date2" name="date2" style="display: none;">
      <div class="col-xxl-6 col-xl-6 col-md-6 col-12" > 
          <div class="align-items-center" style="">
            <label class='labelguild'>Start Date 2</label>
            <br>
            <input type="text" name="daterange" value="" id="daterange" class="labelinput"  style="width:100%" />
            <label id="daterangeErr" class="failed"></label>
        </div> 
    </div>
</div>
<div class="selecteddate" id="selecteddate" style="display:none">
  <div class="col-xxl-3 col-xl-3 col-md-3 col-12" > 
      <div class="align-items-center" style="width: 100%;">
        <label class='labelguild'>Start Time</label>
        <br>
        <input type="time" name="starttime"  style="width: 100%;" class="labelinput">
...
<div class="col-xxl-3 col-xl-3 col-md-3 col-12" > 
  <div class="align-items-center" style="width: 100%;">
    ...
    <br>
    <input type="time" name="endtime"  style="width: 100%;" class="labelinput">
...
<div class="d-flex align-items-cente p-2">
    <div class="col-xxl-12  col-md-12" style="padding:0px;width: 100%;">
      <div class="col-xxl-6 col-xl-6 col-md-6 col-12" > 
          <div class="align-items-center" style="width: 100%;">
            ...
            <br>
            <input type="text" name="venue"  style="width: 100%;" class="labelinput" placeholder="Venue">
    ...
    <div class="col-xxl-6 col-xl-6 col-md-6 col-12" > 
      <div class="align-items-center" style="width: 100%;">
        ...
        <br>
        <input type="text" name="address"  style="width: 100%;" class="labelinput" placeholder="Address">
