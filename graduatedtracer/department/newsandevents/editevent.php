...
<body>
  ...
  <script type="text/javascript">
    ...
    function validateForm() {
        ...
        var oldimagevalidation = document.contactForm.oldimagevalidation.value;
...
<!-- ======= Header ======= -->
<?php if(isset($_SESSION['editeventsuccess'])) {?>
    <div id="undo-hidden">
...
<form action="editeventserver.php" method="POST" name="contactForm" onsubmit="return validateForm()" id="formulario"  enctype="multipart/form-data">
  <input type="text" name="oldimagevalidation" value="1" id="oldimagevalidation">
