...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
  ...
  if ($username != "") {
    ...
    if (isset($_SESSION['newsid'])) {
      ...
      $spesplit2 = explode(', ', $newsimage);  
      for($i=0; $i<sizeof($spesplit2); $i++){
        if ($spesplit2[$i] != "") {
          $newsimagesplit .= "  <div class='image'> <img src='../../uploadimage/".$spesplit2[$i]."'></div>";
        }
...
<!-- ======= Header ======= -->
<?php if(isset($_SESSION['editdepartmentnewssucess'])) {?>
  <div id="undo-hidden">
    ...
    <div class="container-undo1">
      <div class="container-undo01" align="center">
        ...
        <label class="title_info">
          ...
          <br>
          <label style="font-size: 2em;margin-top: 20px;">NEWS UPDATED!</label>
        </label><br>
      </div>
    </div>
...
unset($_SESSION['editdepartmentnewssucess']);
?>
...
<aside id="sidebar" class="sidebar" style="background-color: #07435f;">
  ...
  <form action="editnewsserver.php" method="POST" name="contactForm" onsubmit="return validateForm()" id="formulario"  enctype="multipart/form-data">
    <input type="text" name="newsid" value="<?php echo $newsid ?>" style='display: none;'>
     ...
     <div class="col-xxl-8 col-xl-8  col-md-12 col-sm-12" style="background-color: #fff;margin-top: 20px;">
       <div class="d-flex align-items-cente p-1 ">
        <div class="align-items-center" style="width: 100%;margin-left: 13px;margin-right: 13px;margin-top: 10px;">
          ...
          <br>
          <input type="text" name="newsdetail"  style="width: 100%;" class="labelinput" placeholder="News Title" value="<?php echo $newsdetail; ?>">
