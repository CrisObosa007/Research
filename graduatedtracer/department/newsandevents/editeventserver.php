...
if(isset($_POST['submit'])){
  ...
  if ($fileName == "") {
                     $result = mysqli_query($conn,"UPDATE event SET eventdetail = '$eventdetail', startdate = '$startdate', starttime = '$starttime', enddate = '$enddate', venue = '$venue', address = '$address', description = '$description', organizer = '$organizer1', sponsor = '$sponsor1' where eventid='$eventid' ");
      ...
      $result1 = mysqli_query($conn,"INSERT INTO alevent (uploadedevent,eventcollege,eventdetail,startdate,starttime,enddate,endtime,venue,address,description,organizer,sponsor,eventimage,eventdate,time,status) values ('$college','$college','$eventdetail','$startdate','$starttime','$enddate','$endtime','$venue','$address','$description','$organizer1','$sponsor1','$eventimage','$eventdate','$time','update')");


        
              }else{
                                                           $result = mysqli_query($conn,"UPDATE event SET eventdetail = '$eventdetail', startdate = '$startdate', starttime = '$starttime', enddate = '$enddate', venue = '$venue', address = '$address', description = '$description', organizer = '$organizer1', sponsor = '$sponsor1', eventimage = '$allfiles' where eventid='$eventid' ");
      ...
      $result1 = mysqli_query($conn,"INSERT INTO alevent (uploadedevent,eventcollege,eventdetail,startdate,starttime,enddate,endtime,venue,address,description,organizer,sponsor,eventimage,eventdate,time,status) values ('$college','$college','$eventdetail','$startdate','$starttime','$enddate','$endtime','$venue','$address','$description','$organizer1','$sponsor1','$allfiles','$eventdate','$time','update')");
        ...
        $_SESSION['editeventsuccess'] = "asdasdsa";
