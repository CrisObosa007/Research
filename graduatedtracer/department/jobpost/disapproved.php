...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
  ...
  $result=mysqli_query($conn,"UPDATE college set notification='' where college='$college'");
?>
<!DOCTYPE html>
<html lang="en">
...
<table id="myTable" class="table table-striped" width="100%" style=""> 
        ...
        <tbody>  
        <?php 
        $sql = "select * from jobpost where jobstatus = 'Disapproved' and collegeuploaded = '$college'";
