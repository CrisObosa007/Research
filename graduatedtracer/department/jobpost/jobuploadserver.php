...
include '../dbhelper.php';
 ...
 if(isset($_POST['submit'])){
  ...
  $result = mysqli_query($conn,"INSERT INTO jobpost (jobtitle,companyname,email,contact,link,startdate,enddate,jobtype,location,specialization,qualification,description,jobstatus,collegeuploaded,jobpostdate,jobposttime,minimumsalary,maximumsalary) values ('$jobtitle','$companyname','$email','$contact','$link','$startdate','$enddate','$jobtype','$location','$specialization1','$qualification1','$description','pending','$college','$jobpostdate','$time','$minimumsalary','$maximumsalary')");

  $result = mysqli_query($conn,"INSERT INTO aljobpost (jobtitle,companyname,email,contact,link,startdate,enddate,jobtype,location,specialization,qualification,description,jobstatus,collegeuploaded,jobpostdate,jobposttime,minimumsalary,maximumsalary) values ('$jobtitle','$companyname','$email','$contact','$link','$startdate','$enddate','$jobtype','$location','$specialization1','$qualification1','$description','upload','$college','$jobpostdate','$time','$minimumsalary','$maximumsalary')");

  if ($result) {
    $_SESSION['departmentjobssucess'] = "asdasdsa";
