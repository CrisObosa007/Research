...
<!-- ======= Header ======= -->
<?php if(isset($_SESSION['departmentjobssucess'])) {?>
    <div id="undo-hidden">
...
unset($_SESSION['departmentjobssucess']);
?>
...
<div class="d-flex align-items-cente p-2" >
    <div class="align-items-center" style="width: 100%;">
        ...
        <br>
         <label style="margin-left: 5px;color: #B2AAAA;margin-top: 2px;font-size: 1.5vmin;" id="optionaljobtype">( Optional )</label>
