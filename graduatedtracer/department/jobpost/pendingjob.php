...
<script type="text/javascript">
  ...
  <!-- ======= Header ======= -->
      <?php if(isset($_SESSION['canceldepartmentjobssucess'])) {?>
    <div id="undo-hidden">
          <input type="checkbox" id="tableundo"><label for="tableundo"  class=""></label>
                     <div class="container-undo1">
                          <div class="container-undo01" align="center">
                                ...
                                <br>
                                <label style="font-size: 2em;margin-top: 20px;">JOB CANCELLED!</label>
                                </label><br>
                          </div>
                    </div>
...
unset($_SESSION['canceldepartmentjobssucess']);
 ?>
       ...
       <div class="col-xxl-7 col-md-7">
              ...
              <nav >
                <ol class="breadcrumb" style="background-color:transparent;">
                  ...
                  <li class="breadcrumb-item active">Pending Job Approval(Guidance)</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
...
<table id="myTable" class="table table-striped" width="100%" style=""> 
        <thead>  
          <tr>  
                 <th style="border-bottom:solid 1px;width: 40%;font-size: 1.7vmin;">Company Name</th>  
            <th style="border-bottom:solid 1px;width: 35%;font-size: 1.7vmin;">Job Title</th>  
            <th style="border-bottom:solid 1px;width: 25%;font-size: 1.7vmin;">Action</th> 
          </tr>  
        </thead>  
        <tbody>  
        <?php 
        $sql = "select * from jobpost where jobstatus = 'pending' and collegeuploaded = '$college'";
   ...
   <label style=' font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;padding: 0px .3vmin 0px .3vmin;font-weight:600' for='a".$row['id']."'>View</label>
          ...
          <style>#a".$row['id'].":checked ~ .container1{display: block;visibility: visible;}</style>
            ...
            <input type='hidden' id='".$row['id']."' name='jobid' value='".$row['id']."'>
           ...
           <button style='display:none' name='editbutton' id='editbutton".$row['id']."'></button>
           <label style=' font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;padding: 0px .3vmin 0px .3vmin;font-weight:600' for='editbutton".$row['id']."'>Update</label>
           </i></label>
           </form>
           ...
           <label style=' font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;padding: 0px .3vmin 0px .3vmin;font-weight:600' for='c".$row['id']."'>Cancel</label>
           </i></label>
                          ...
                          <div class='container03'>
                            ...
                            <tr>
                              ...
                              <div class='closingtab3'>
                               ...
                               <label style='text-align: center;width:100%;font-size:3.5vmin;color:#0c506f;margin:0;padding:0;font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;'>".$row['jobtitle']."</label>
                              </td>
                                <tr>
                                      ...
                                      <div style='width:100%' align='left'class='form-group options'>
                                          <label class='infolabel1' style='font-size:2.3vmin'>Reason for Cancelling? <label style='color:red'>*</label></label>
                                           ...
                                           <div style='width:100%'>
                                            ...
                                            <div style='width:100%'>
                                              <input type='checkbox' name='reasons[]' value='Data is not specific' style='display:inline-block;position: relative;height:2.1vmin;width:2.1vmin;margin:5px 0px 0px 5px' required>
                                              <label class='infolabel2'>Data is not specific</label>
                                            </div>
