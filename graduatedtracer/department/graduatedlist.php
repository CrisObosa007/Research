...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
  ...
  $college = $row['college'];
     ...
     if (isset($_POST['employed'])) {
       $_SESSION['employed'] = "SELECT * FROM graduated JOIN employment ON graduated.college = employment.empcollege WHERE employment.empcollege like '%$college%' and employment.employed = 'Yes' and graduated.idno = employment.idno";
     ...
     if (isset($_POST['notemployed'])) {
       $_SESSION['employed'] = "";
       $_SESSION['notemployed'] = "SELECT * FROM graduated JOIN employment ON graduated.college = employment.empcollege WHERE employment.empcollege like '%$college%' and employment.employed = 'No' and graduated.idno = employment.idno";
       $_SESSION['notupdated'] = "";
       $_SESSION['graduated'] = "";
     ...
     if (isset($_POST['notupdated'])) {
       $_SESSION['employed'] = "";
       $_SESSION['notemployed'] = "";
       $_SESSION['notupdated'] = "SELECT * FROM graduated JOIN employment ON graduated.college = employment.empcollege WHERE employment.empcollege like '%$college%' and employment.employed = '' and graduated.idno = employment.idno";
       $_SESSION['graduated'] = "";
     ...
     if (isset($_POST['graduated'])) {
       ...
       $_SESSION['notemployed'] = "";
       $_SESSION['notupdated'] = "";
       $_SESSION['graduated'] = "SELECT * FROM graduated JOIN employment ON graduated.college = employment.empcollege and graduated.idno = employment.idno WHERE employment.empcollege like '%$college%'";
    ...
    <table id="myTable" class="table table-striped" width="100%"> 
        <thead>  
          <tr>  
            ...
            <th style="border-bottom:solid 1px;width: 20%;font-size: 1.7vmin;">Contact</th>
            <th style="border-bottom:solid 1px;width: 10%;font-size: 1.7vmin;">Action</th>  
            <?php }?>
