...
$target_dir = "../graduatedstudent/graduatedimage";
$image = $_POST['image'];
$idno = $_POST['idno'];


$namephoto = rand(). "_" . time() . ".jpeg";
$target_dir = $target_dir . "/" . $namephoto ;
if (file_put_contents($target_dir, base64_decode($image))) {
    $result=mysqli_query($conn,"UPDATE graduated set graduatedimage = '$namephoto'  where idno='$idno'");
