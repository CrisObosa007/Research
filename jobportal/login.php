...
if (isset($_POST['idno']) && isset($_POST['password'])) {
  if ($db->dbConnect()) {
    if ($db->logIn("graduated", $_POST['idno'], $_POST['password'])) {
     $user = $db->getUserByUsername($_POST['idno']);
     ...
     $loginidno =  $user['idno'];
               ...
               date_default_timezone_set('Asia/Manila');
                    ...
                    mysqli_query($conn,"INSERT INTO login (username,date,time)values('$loginidno','$date','$time')");
