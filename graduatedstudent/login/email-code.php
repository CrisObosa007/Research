    ...
    <div class="limiter">
        <div class="container-login100" style="background-color: #0c506f;">
            ...
            <div class="wrap-login100 " align="center">
                 ...
                 <a href="register.php" >
                    <label style='background-color:#07435f;color:#fff;font-size:1.7vmin;margin:0;padding: 1.3vmin 1.5vmin 1vmin 1.5vmin;' class='backbutton'>
              ...
              <style type="text/css">
                    .backbutton:hover{
                        background-color: #06597F !important;
                        color: #E7E7E7 !important;
                    }
                </style>
             <form class="login100-form validate-form p-l-55 p-r-55  p-b-30" action="email-code.php" method="POST" autocomplete="">
