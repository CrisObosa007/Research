...
<aside id="sidebar" class="sidebar">
  ...
  <main id="main" class="main">
    ...
    <div style="width:100%;text-align: right;">
      <a href="news.php"><label class="backbutton">Back to News </label></a>
    </div>
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-xxl-8 " style="background-color:#fff;box-shadow: 0 1px 8px 0 rgba(0, 0, 0, 0.2), 0 1px 20px 0 rgba(0, 0, 0, 0.19);">
              <div style="background-color: transparent;width: 100%;text-align: center;">
              <label style="font-size: 25px;padding: 10px;color: #000;"> <?php echo $newsdetail ?></label>
              </div>
              <div style="background-color: transparent;width: 100%;text-align: center;">
              <img src='../../../graduatedtracer/uploadimage/<?php echo $newsimage ?>' alt='Profile' style='width:30%;height: same-as-width;margin-top: 20px;'>
              </div>
              <div style="background-color: transparent;width: 100%;text-align: left;padding: 30px 10px 0px 10px;">
              <label style="font-size: 17px;padding: 10px;color: #636363; font-weight:600">The <?php echo $category ?> took at the <?php echo $address ?> and it's Venue in the <?php echo $venue ?></label>
              </div>
              <div style="background-color: transparent;width: 100%;text-align: left;padding: 0px 10px 0px 10px;">
              <label style="font-size: 17px;padding: 10px;color: #636363;text-align: justify;text-justify: inter-word;  font-weight:600"><?php echo $description ?> </label>
              </div>
              <div style="background-color: transparent;width: 100%;text-align: left;padding: 0px 10px 0px 10px;margin-top: -10px;text-align: right;">
              <label style="font-size: 15px;padding: 10px;color: #000;"><?php echo $newsdate ?> </label>
              </dv>i
            </div>
