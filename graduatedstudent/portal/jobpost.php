...
// or simply
    ...
    <meta charset="utf-8">
    <meta content="width=device-width, initial-scale=1.0" name="viewport">  <title>Job Post</title>
         ...
         <div class="col-10">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body" style="border-top: 3px solid #297fa7;">
                    ...
                    <li class="nav-item">
                      <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview" onclick="alljobs()" style="font-size: 2.2vmin;">All Jobs</button>
                    </li>

                    <li class="nav-item">
                      <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit" onclick="recommededjobs()"  style="font-size: 2.2vmin;">Recommended Jobs</button>
                    </li>
                  </ul>
                  <script type="text/javascript">
                    function alljobs() {
...
<!-- -------------first table ------------------------ -->
              <div class="table-responsive" id="table-responsive1" style="padding-top:20px;">

                <table id="myTable" width="100%" style="padding-bottom: 30px;"> 
...
<!-- -------------second table ------------------------ -->
  <div class="table-responsive" id="table-responsive2" style="padding-top:20px;display: none;">

                <table id="myTable2" width="100%" style="padding-bottom: 30px;"> 
                  <thead style="display:none">  
                    <tr>  
                      <th style="border-bottom:solid 1px;" style="width: 20%;">Photo</th>
                      <th style="border-bottom:solid 1px;" style="width: 10%;">Date</th>    
