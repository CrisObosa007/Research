...
alert = function() {};
  ...
  <meta charset="utf-8">
  <meta content="width=device-width, initial-scale=1.0" name="viewport">  <title>Job Vocancy</title>
                ...
                <ol class="breadcrumb" style="background-color:transparent;">
                  ...
                  <div class="col-lg-12">
                       ...
                       <div class="col-xxl-10 col-md-12">
                            <label style="   font-family: Roboto,Helvetica Neue, HelveticaNeue, Helvetica, Arial, sans-serif;font-weight: 500;font-size: 3vmin;color: #202020;">All Jobs</label>
                       </div>
                  </div>
        <!-- Left side columns -->
        <div class="col-lg-12">
          ...
          while ($row = mysqli_fetch_array($result)) { 
            ...
            <div class='col-xxl-12' >
              <div class='card info-card sales-card'  style='background-color:transparent;border-radius:10px;box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px;'>
                <form method='POST' action='jobhiringinfo.php'>
